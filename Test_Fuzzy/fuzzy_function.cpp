...
//Fuzzy Set Output pH
float fsopH_sebentar[3] = {0, 0, 3000};
float fsopH_sedang[3] = {2000, 5000, 9000};
float fsopH_lama[3] = {6000, 10000, 10000};
...
float fsoPPM_sebentar[3] = {0, 0, 4500};
float fsoPPM_sedang[3] = {3000, 7500, 13500};
float fsoPPM_lama[3] = {9000, 15000, 15000};
...
float MomentpH1, MomentpH2, MomentpH3, MomentpH4, MomentpH5, MomentpH6, MomentpH7;
float AreaPPM1, AreaPPM2, AreaPPM3, AreaPPM4, AreaPPM5, AreaPPM6, AreaPPM7;
float MomentPPM1, MomentPPM2, MomentPPM3, MomentPPM4, MomentPPM5, MomentPPM6, MomentPPM7;
...
MomentpH1 = fx(a1, fsopH_sebentar[2], fsopH_sebentar[2], (fsopH_sebentar[2]-fsopH_sebentar[0]), 1);
MomentpH2 = fx(fsopH_sebentar[0], a1, mfipH_kecil(), 0, 0);
MomentpH3 = fx(fsopH_sedang[0], b1a, fsopH_sedang[0], (fsopH_sedang[1] - fsopH_sedang[0]), 0);
MomentpH4 = fx (b1b, fsopH_sedang[2], fsopH_sedang[2], (fsopH_sedang[2]-fsopH_sedang[1]), 1);
MomentpH5 = fx (b1a, b1b, mfipH_sedang(), 0, 0);
MomentpH6 = fx(fsopH_lama[0], c1, fsopH_lama[0], (fsopH_lama[2]-fsopH_lama[0]), 0);
MomentpH7 = fx(c1, fsopH_lama[2], mfipH_besar(), 0, 0);

MomentPPM1 = fx(a2, fsoPPM_sebentar[2], fsoPPM_sebentar[2], (fsoPPM_sebentar[2]-fsoPPM_sebentar[0]), 1);
MomentPPM2 = fx(fsoPPM_sebentar[0], a2, mfiPPM_kecil(), 0, 0);
MomentPPM3 = fx(fsoPPM_sedang[0], b2a, fsoPPM_sedang[0], (fsoPPM_sedang[1] - fsoPPM_sedang[0]), 0);
MomentPPM4 = fx (b2b, fsoPPM_sedang[2], fsoPPM_sedang[2], (fsoPPM_sedang[2]-fsoPPM_sedang[1]), 1);
MomentPPM5 = fx (b2a, b2b, mfiPPM_sedang(), 0, 0);
MomentPPM6 = fx(fsoPPM_lama[0], c2, fsoPPM_lama[0], (fsoPPM_lama[2]-fsoPPM_lama[0]), 0);
MomentPPM7 = fx(c2, fsoPPM_lama[2], mfiPPM_besar(), 0, 0);
}

float deffuzzyfikasi_pH(){
return (MomentpH1+MomentpH2+MomentpH3+MomentpH4+MomentpH5+MomentpH6+MomentpH7)/(AreapH1+AreapH2+AreapH3+AreapH4+AreapH5+AreapH6+AreapH7);
}

float deffuzzyfikasi_PPM(){
return (MomentPPM1+MomentPPM2+MomentPPM3+MomentPPM4+MomentPPM5+MomentPPM6+MomentPPM7)/(AreaPPM1+AreaPPM2+AreaPPM3+AreaPPM4+AreaPPM5+AreaPPM6+AreaPPM7);
}
